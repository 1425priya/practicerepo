 ...
 const [value, setValue] = React.useState(2);
  ...
  return (
    ...
    <div className="about-header-text container flex">
                <h1>Learn about Uptime.com</h1>
                <p>Our passion is peace of mind. Meet the company trusted to monitor the world's top websites.</p>
            </div>
            <div className="big-section-feature container flex">
                ...
                <div className="feature-description flex">
                    ...
                    <p>Uptime.com was founded after we experienced a major web outage and couldn’t find a solution that was both affordable and user-friendly.
Turns out we weren’t alone.</p>
             ...
             <div className="big-section-feature container flex">
                ...
                <div className="feature-description flex">
                    ...
                    <p>Our unique combination of top-rated website monitoring technology and 100% dedicated human support has gotten us recognized as one of the world's best solutions to use (and work with) for nearly a decade..</p>
                </div>
             ...
             <div className="about-header-text container flex">
                ...
                <p>See the values Uptime.com was built on.</p>
            </div>
            ...
            <div className="review-big-section-feature container flex">
                ...
                <div className="review-feature-description flex">
                    ...
                    <p>"The collaboration is incredible. Everyone is smart and engaged, sharing ideas and looking for improvement. And getting feedback from customers who love what we do for them makes it all very satisfying. The fully-remote work really suits my lifestyle, and company-wide meetups are always a lot of fun as well."</p>
                </div>
