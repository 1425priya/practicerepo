...
export default function Mointor() { 
   return (
    <div>
      <div id="pop-up">
        <img src="myImage.jpeg" alt="" width={'300px'}/>
      </div>
      <header>
        ...
        <p className="white conatiner flex">Currently, we keep an eye on '7,100,000' monitors for more than '1,900,000' users and companies.</p>
      </header>
      ...
      <div className="feature-sec">
        ...
        <Card className="card" sx={{boxShadow:'0 0 10px #888', '&:hover':{transform:'scale(1.1)',transition:'1s ease-in-out'} }}> 
    ...
    <Card className="card" sx={{boxShadow:'0 0 10px #888', '&:hover':{transform:'scale(1.1)',transition:'1s ease-in-out'} }}> 
      ...
      <Button variant="contained" sx={{backgroundColor:'greenyellow','&:hover':{backgroundColor:'#3bd671'}}}>
        ...
        <button className="get-started-btn container flex ">Start mointoring in the 30 secounds</button>
      </div>
